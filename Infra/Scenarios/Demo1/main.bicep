...
output vmConnectHint string = 'Bastion RDP → ${vm.outputs.vmName}. Username: ${vmAdminUsername}. Password: Key Vault secret vm-admin-password in ${keyVault.outputs.keyVaultName}.'
